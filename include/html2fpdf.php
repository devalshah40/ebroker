...
function HTML2FPDF($orientation='P',$unit='mm',$format='A4',$font='helvetica',$fsize=7)  {
/*
	orientation = p or l
...
//	$this->SetFont('Arial','',11); // Changeable?(not yet...)
  ...
  $this->lineheight = $lheight;                                  // +++++++ this controls spacing between lines (but not table cells)
  ...
  $this->strike=false;
	...
	$this->currentfont='serif';         // +++++++++++ you can set the default / only font here
	$this->currentstyle='';
...
// --- chris added June 25 (doesn't seem to have any effect---
